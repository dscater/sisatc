...
const { setIncidencia, limpiarIncidencia, form } = useIncidencias();
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            let respuesta = await axiosDelete(
                route("incidencias.destroy", item.id),
            );
...
<template>
    <Head title="Gestión de Incidencias"></Head>
    ...
    <Content>
        <template #header>
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="m-0">
                        <i class="fa fa-list"></i> Gestión de Incidencias
                    </h3>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-12">
                        <MiTable
                            ...
                            :cols="headers"
                            :api="true"
                            :url="route('incidencias.paginado')"
                            :numPages="5"
